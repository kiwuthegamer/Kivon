// Starting 
function start(){
  document.getElementById('output').value="Kivon Alpha 0.6";
}
...
//quick quiz
function qq(){
  var txt = "var ans1 4\nvar ans2 15\nvar ans3 35\nalert Quiz!\nalert Question 1 - \nvar res1 $prompt 2+2=?\nalert Question 2 - \nvar res2 $prompt 5+10=?\nalert Question 3 - \nvar res3 $prompt 15+20=?\nprint Q1 - \nif ans1 = res1 then print Correct\nif ans1 ! res1 then print Wrong\nprint \\n\nprint \\n\nprint Q2 - \nif ans2 = res2 then print Correct\nif ans2 ! res2 then print Wrong\nprint \\n\nprint \\n\nprint Q3 - \nif ans3 = res3 then print Correct\nif ans3 ! res3 then print Wrong"
  document.getElementById('input').value=txt;
}
